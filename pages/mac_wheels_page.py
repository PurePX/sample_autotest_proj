...
class MacWheelsPage(Base): #Probably can be universal item page
    ...
    # brand_dropdown_mac_pro_option = "//label[@for='facet-12820']"
    ...
    #     return WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable((By.XPATH, self.brand_dropdown_mac_pro_option)))
    #
    ...
    #
    # def click_brand_dropdown_mac_pro_option(self):
    ...
    #     self.click_brand_dropdown_mac_pro_option()
    #     time.sleep(2)
